...
4.Select one independent variable (X) and one dependent variable (y).
5.Split the dataset into training and testing sets.
6.Train the Simple Linear Regression model.
7.Predict values using the trained model.
8.Visualize the regression line and data points.
9.Evaluate the model performance using regression metrics.
10.Interpret the results and predictions.
